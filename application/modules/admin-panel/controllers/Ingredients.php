...
class Ingredients extends Admin_controller  {
	...
	{
		parent::__construct();
		$this->path = $this->config->item('ingredients');
	}

	protected $table = 'ingredients';
	protected $redirect = 'ingredients';
    ...
    {
        check_ajax();
        $this->load->model('Ingredient_model', 'data');
    ...
    public function add_update($id=0)
	{
        ...
        if($id !== 0) $data['data'] = $this->main->get($this->table, 'i_title, image', ['id' => d_id($id)]);
